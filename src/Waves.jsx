...
const paths = [
  "M0 251L30 263.7C60 276.3 120 301.7 180 290.3C240 279 300 231 360 216.7C420 202.3 480 221.7 510 231.3L540 241L540 0L510 0C480 0 420 0 360 0C300 0 240 0 180 0C120 0 60 0 30 0L0 0Z",
  "M0 68L22.5 76C45 84 90 100 135 104.8C180 109.7 225 103.3 270 101.8C315 100.3 360 103.7 405 106.8C450 110 495 113 517.5 114.5L540 116L540 0L517.5 0C495 0 450 0 405 0C360 0 315 0 270 0C225 0 180 0 135 0C90 0 45 0 22.5 0L0 0Z",
  "M0 251L30 263.7C60 276.3 120 301.7 180 290.3C240 279 300 231 360 216.7C420 202.3 480 221.7 510 231.3L540 241L540 0L510 0C480 0 420 0 360 0C300 0 240 0 180 0C120 0 60 0 30 0L0 0Z",
];
export default function Waves() {
  ...
  useEffect(() => {
    // every 1 second, switch to the next path
    const interval = setInterval(() => {
      console.log("interval", pathIndex);
      setPathIndex((pathIndex) => (pathIndex + 1) % paths.length);
    }, 1000);
    return () => clearInterval(interval);
  }, []);

  return (
    <svg id="waves" viewBox="0 0 540 960" width="540" height="960">
      <path id="path-1" d={paths[pathIndex]} fill="#ff6161"></path>
      <path
        id="path-2"
